function GetPluginSettings()
{
    return {
        ...
        "description": "VK interaction. Теперь малиновый!", // description
        "author": "AquaBarbus",
        "help url": "https://bitbucket.org/AquaBarbus/c2-vkapi",
...
AddCondition(5, cf_trigger, "On Order Cancel", "Операции с голосами", "On Order Cancel", "Событие происходит, когда пользователь отменяет покупку.", "onOrdCan");
AddCondition(6, cf_trigger, "On Order Success", "Операции с голосами", "On Order Success", "Событие происходит, когда покупка закончилась успешно.", "onOrdSuc");
AddCondition(7, cf_trigger, "On Order Fail", "Операции с голосами", "On Order Fail", "Событие происходит, когда покупка закончилась неуспешно.", "onOrdFail");
...
AddCondition(13, cf_trigger, "On App Users Loaded", "Друзья", "On App Users Loaded", "Событие происходит, когда отработала ф-ция AppUsersGet", "onAppUsersLoad");
AddCondition(14, cf_trigger, "On Online Loaded", "Друзья", "On Online Loaded", "Событие происходит, когда отработала ф-ция OnlineGet", "onOnlineLoad");

AddCondition(15, cf_trigger, "On Online Error", "Друзья", "On Online Error", "Событие происходит, когда произошла ошибка в OnlineGet", "onOnlineLoadErr");
AddCondition(16, cf_trigger, "On Friends List Error", "Друзья", "On Friends List Error", "Событие происходит, когда ошибка в Friends Get", "onFrLoadErr");
AddCondition(17, cf_trigger, "On App Users Error", "Друзья", "On App Users Error", "Событие происходит, когда ошибка ф-ция AppUsersGet", "onAppUsersLoadErr");

AddCondition(18, 0, "Is Ready", "Основное", "Is VK Ready", "Правдиво, когда вк инициализировался, использовать вместо On ready! ", "IsReady");

AddCondition(19, cf_trigger, "On URL Wall Upload Server Detected", "Фотографии", "On URL Wall Upload Server Detected", "Событие происходит, когда получен адрес сервера для загрузки фото на стену", "onGetWallUpServer");
AddCondition(20, cf_trigger, "On Photo Wall Saved", "Фотографии", "On Photo Wall Saved", "Событие происходит, когда фото сохранились после вызова Photo Wall Save", "onPhotoWallSaved");
...
AddExpression(9, ef_return_string, "Получить JSON массив друзей у которых установлено приложение", "Друзья", "AppUsersDataJsonArr", "Массив со структорой для импорта в массив типа Construct Array");
AddExpression(10, ef_return_string, "Получить JSON массив онлайн друзей", "Друзья", "OnlineDataJsonArr", "Массив со структорой для импорта в массив типа Construct Array");

AddExpression(11, ef_return_string, "Получить URL сервера для аплоада фото на стену", "Фотографии", "ServerWallUpUrl", "URL сервера для стены");
AddExpression(12, ef_return_string, "Получить id сохраненного фото для стены", "Фотографии", "GetWallPhotoId", "Например photo152321_1231351");
...
AddStringParam("count", "предустановленное количество голосов");
AddAction(1, 0, "Show Order Box", "Платежи", "Количество <i>{0}</i>", "Открыть окно работы с голосами", "ShowOrderBox");
...
AddStringParam("fields", "поля данных которые необходимо получить через запятую, например uid, first_name, last_name, sex, bdate, city, country, timezone, photo, photo_medium, photo_big", "\"uid, first_name, last_name, sex, bdate, city, country, timezone, photo, photo_medium, photo_big\"");
...
AddAction(9, 0, "AppUsers Get", "Друзья", "Получить id которые установли приложение", "Получить id которые установли приложение в jsonarray для импорта в Array(Construct)", "AppUsersGet");

AddStringParam("count", "количество друзей, которое нужно вернуть. (по умолчанию – все друзья)");
AddStringParam("offset", "смещение, необходимое для выборки определенного подмножества друзей.");
AddAction(10, 0, "Online Get", "Друзья", "Получить список друзей онлайн количество:<i>{0}</i>, смещение:<i>{1}</i>", "Получить список онлайн в jsonarray для импорта в Array(Construct)", "OnlineGet");

AddStringParam("gid", "ID группы, при загрузке фотографии в группу.");
AddAction(11, 0, "Get Wall Upload Server", "Фотографии", "Возвращает адрес сервера для загрузки фотографий на стену.", "Возвращает адрес сервера для загрузки фотографий на стену.", "GetWallUpServer");

AddStringParam("json", "Массив полученный от сервера загрузок");
AddStringParam("uid", "ID пользователя, которому нужно сохранить фото");
AddStringParam("gid", "ID группы, при загрузке фотографии в группу.");
AddAction(12, 0, "Save Wall photo", "Фотографии", "Сохранить фото для стены", "Сохраняет фото для стены", "SaveWallPhoto");
////////////////////////////////////////
ACESDone();
